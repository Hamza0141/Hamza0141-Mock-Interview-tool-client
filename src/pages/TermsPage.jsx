      ...
      <div className="max-w-5xl mx-auto bg-[var(--color-bg-panel)] border border-[var(--color-border)] rounded-2xl shadow-sm p-8 md:p-10 space-y-8">
        ...
        <header className="space-y-2 text-center">
          <h1 className="text-3xl font-bold text-[var(--color-primary)]">
            Prepare With AI – Terms & Conditions
          </h1>
        ...
        <section className="space-y-3 text-sm leading-relaxed">
          <p>
            Welcome to <span className="font-semibold">Prepare With AI</span>{" "}
            (“we”, “us”, or “our”). These Terms &amp; Conditions (“Terms”)
            govern your access to and use of the Prepare With AI platform,
            including our website and related services (collectively, the
            “Service”).
          </p>
          <p>
            By creating an account, accessing, or using Prepare With AI, you
        ...
        <section className="space-y-2">
          ...
          <p className="text-sm leading-relaxed">
            Prepare With AI does not collect or verify your date of birth. By
            using the Service, you confirm that:
          </p>
        ...
        <section className="space-y-2">
          ...
          <p className="text-sm leading-relaxed">
            To use Prepare With AI, you must create an account by providing:
          </p>
          <ul className="list-disc pl-5 text-sm space-y-1 leading-relaxed">
            <li>First name</li>
            <li>Last name</li>
          ...
          <p className="text-sm leading-relaxed">
            ...
            You may contact us at by creating a ticket in your account to
            request changes or discuss data removal options where applicable.
          </p>
        </section>
        ...
        <section className="space-y-2">
          ...
          <p className="text-sm leading-relaxed">
            Prepare With AI is designed to store only the minimum data required
        ...
        <section className="space-y-2">
          ...
          <p className="text-sm leading-relaxed">
            ...
            or public speaking environment. Prepare With AI uses the camera only
            to create a more immersive experience. We do not store or analyze
            your video beyond the live session.
          </p>
        ...
        <section className="space-y-2">
          ...
          <p className="text-sm leading-relaxed">
            ...
            <span className="font-semibold">Stripe</span>. Prepare With AI
            itself does not store sensitive payment details.
          </p>
          <p className="text-sm leading-relaxed">
        ...
        <section className="space-y-2">
          ...
          <p className="text-sm leading-relaxed">
            Prepare With AI uses cookies primarily to maintain secure sessions
            and understand who is making a request.
          </p>
          ...
          <p className="text-sm leading-relaxed">
            By using Prepare With AI, you consent to the use of these essential
        ...
        <section className="space-y-2">
          ...
          <p className="text-sm leading-relaxed">
            Prepare With AI uses AI models (including those provided by OpenAI)
            to generate questions, feedback, and evaluations. While we aim to be
            helpful:
          </p>
          <ul className="list-disc pl-5 text-sm space-y-1 leading-relaxed">
        ...
        <section className="space-y-2">
          ...
          <p className="text-sm leading-relaxed">
            ...
            effective when posted on the website. Your continued use of Prepare
            With AI after changes are posted means you accept the revised Terms.
          </p>
          <p className="text-sm leading-relaxed">

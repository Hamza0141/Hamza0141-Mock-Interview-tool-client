          ...
          >
            <div className="row g-0">
              ...
              <div
                ...
                style={{
                  background: "linear-gradient(145deg, var(--color-primary), #4b6cb7)",
                  color: "#fff",
                  minHeight: "100%",
                }}
              >
                <div>
                  ...
                  <div className="mt-4">
                    ...
                    <ul className="list-unstyled small mb-0 opacity-90">
                      ...
                      <li className="mb-2">• AI-powered public speaking feedback</li>
                      <li className="mb-2">• Understand your strengths & growth areas</li>
                    </ul>
                  </div>
                </div>
              ...
              <div className="col-12 col-md-7">
                <div className="p-4 p-md-5 h-100 d-flex flex-column">
                  ...
                  >
                    {isRegisterStep ? "Create your account" : "Verify your email"}
                  </h2>
                  ...
                  {!showVerify ? (
                    <form onSubmit={handleRegister} className="mt-3">
                      ...
                      <div className="mt-3">
                        ...
                        />
                        <small className="form-text" style={{ color: "var(--color-text-muted)" }}>
                  ...
                  {isRegisterStep && (
                    ...
                    >
                      ...
                      <button
                        ...
                        onClick={() => navigate("/login")}
                        className="btn btn-link p-0 align-baseline"
                        style={{ fontSize: "0.85rem", color: "var(--color-secondary)" }}
                      >
                        Login
                      </button>
                    </p>
